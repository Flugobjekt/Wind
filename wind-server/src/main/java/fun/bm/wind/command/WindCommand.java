...
import fun.bm.wind.command.sub.ContextCommand;
import fun.bm.wind.command.sub.WorldsCommand;
...
/**
 * Wind: the fork's own diagnostic command root.
 *
 ...
 */
public class WindCommand extends RootNode {

    public static final String PERM_BASE = "wind.commands";

    public WindCommand() {
        super("wind", PERM_BASE);
        children(
                new ContextCommand(),
                new WorldsCommand()
        );
