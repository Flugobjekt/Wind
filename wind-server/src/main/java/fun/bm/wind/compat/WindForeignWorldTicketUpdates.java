...
/**
 * Wind: do not try to drain <em>another</em> world's pending full-status updates.
 *
 * <h2>The defect</h2>
 ...
 */
public final class WindForeignWorldTicketUpdates {

    private WindForeignWorldTicketUpdates() {
    }
