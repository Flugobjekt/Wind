...
/**
 * Wind: fires the Bukkit portal and teleport events for a vanilla portal, which this platform
 ...
 * {@link WindTeleportEvents} installed there, and it never calls {@code getPortalDestination},
 ...
 */
public final class WindPortalEvents {
    ...
    public static Outcome callPortalEvents(final Entity entity, final ServerLevel destination,
        ...
        final WindTeleportEvents.Destination teleportResult = WindTeleportEvents.callTeleportEvent(
