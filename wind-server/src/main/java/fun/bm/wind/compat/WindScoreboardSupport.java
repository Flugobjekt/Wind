 ...
 *
 * <pre>
 *   compat-config.scoreboard-api=false   # revert to Folia stock: the five methods throw again
 * </pre>
 */
public final class WindScoreboardSupport {
    /**
    ...
    public static void ensureMainBoardStructuralChange(final String what) {
        if (!RegionizedServer.isGlobalTickThread()) {
            throw new IllegalStateException(
                    "Wind: " + what + " on the main scoreboard requires the global region thread"
