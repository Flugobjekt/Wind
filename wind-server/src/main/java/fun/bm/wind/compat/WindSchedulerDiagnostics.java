...
/**
 * Wind: purely diagnostic reporting for Bukkit scheduler calls that Folia rejects.
 *
 ...
 *
 * <p>Kill switch: {@code compat-config.diagnostics=false}.
 */
public final class WindSchedulerDiagnostics {
    ...
    public static String reportRejected(final Plugin plugin,
        ...
        try {
            ...
            LOGGER.warn("""
                            [Wind] Rejected Bukkit scheduler call
                              plugin    : {} v{}
                              jar       : {}
                              jar sha256: {}
            ...
            LOGGER.warn("[Wind] scheduler diagnostics failed (harmless)", t);
