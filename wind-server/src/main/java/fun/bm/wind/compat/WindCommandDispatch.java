...
/**
 * Wind: hand a console-sender {@code Bukkit.dispatchCommand} back to the region that sender
 ...
 *
 * <p>Kill switch: {@code compat-config.command-dispatch-handover=false} restores stock Folia
 * refusal for everything this class would have handed off.
 */
public final class WindCommandDispatch {
    ...
    private static boolean parseFindsSomething(final CommandSender sender, final String command) {
        try {
            ...
            LOGGER.warn("[Wind] could not pre-parse '{}' off the global region; handing it off "
    ...
    private static void report(final String command) {
        ...
        LOGGER.info("[Wind] console-sender dispatch of '{}' was handed to the global region, "
