...
/**
 * Wind: diagnostic output for D-40 - the same-tick second teleport the platform refuses.
 *
 ...
 * tick.
 *
 * <p>Switch: {@code compat-config.teleport-refusal-diagnostics=true}. Default off.
 */
public final class WindTeleportRefusalDiagnostics {
    ...
    public static void reportRefusal(final Entity entity, final net.minecraft.server.level.ServerLevel destination,
        ...
        if (!CompatConfig.teleportRefusalDiagnostics) {
            return;
        }
        try {
            final StringBuilder sb = new StringBuilder(512);
            sb.append("[Wind][D-40] teleportAsync refused by canTeleportAsync()")
            ...
            LOGGER.warn("[Wind][D-40] diagnostic itself failed: {}", t.toString());
        }
    }
    ...
    public static void reportCallbackTransition(final Entity entity,
        ...
        try {
            LOGGER.warn("[Wind][D-40] levelCallback {} -> {}  entity={} id={} at={} thread={}{}",
