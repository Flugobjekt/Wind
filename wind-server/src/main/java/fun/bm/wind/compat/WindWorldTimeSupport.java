...
/**
 * Wind: ownership-safe compatibility boundary for World#setTime and World#setFullTime.
 *
 * <h2>The gap</h2>
...
public final class WindWorldTimeSupport {
    ...
    private static void report(final CraftWorld world, final long targetTime) {
        ...
        if (REPORTED.add(worldName + ":" + targetTime)) {
            LOGGER.info("[Wind] World time mutation to '{}' on world '{}' staged from thread '{}' and dispatched to global region.",
