...
/**
 * Wind: makes a teleport wait for the entity's previous teleport to finish handing it over
 ...
 */
public final class WindTeleportHandover {
    ...
    public static boolean isMidHandover(final CraftEntity entity) {
        if (!CompatConfig.teleportHandover) {
            return false;
        }
