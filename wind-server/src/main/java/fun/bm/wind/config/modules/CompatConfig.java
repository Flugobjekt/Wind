package fun.bm.wind.config.modules;
...
public class CompatConfig {
     ...
     * fun.bm.wind.compat.WindRespawnLocationLookup}.
     */
    @DoNotLoad(when = EnumLoadType.RELOAD)
     ...
     * fun.bm.wind.compat.WindCrossRegionBlockRead}.
     */
    @DoNotLoad(when = EnumLoadType.RELOAD)
     ...
     * fun.bm.wind.compat.WindForeignWorldTicketUpdates}.
     */
    @DoNotLoad(when = EnumLoadType.RELOAD)
     ...
     * {@link fun.bm.wind.compat.WindServerTps}.
     */
    @DoNotLoad(when = EnumLoadType.RELOAD)
     ...
     * Arbitrary async callers remain rejected. See {@link fun.bm.wind.compat.WindWorldTimeSupport}.
     */
    @DoNotLoad(when = EnumLoadType.RELOAD)
